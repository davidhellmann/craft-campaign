...
*/
return [
    '(reply to {email})' => '(antort an {email})',
    '{count} pending sendout(s) queued.' => '{count} austehende Sendungen in der Warteschlange.',
    'A contact must be submitted.' => 'Es muss ein Kontakt angegeben werden.',
    'A contact with that email address could not be found.' => 'Ein Kontakt mit dieser E-Mail-Adresse konnte nicht gefunden werden.',
    'A CSV file must be selected to upload.' => 'Zum Hochladen muss eine CSV-Datei ausgewählt werden.',
    'A label to use for the email field.' => 'Ein Label, die für das E-Mail-Feld verwendet werden soll.',
    'A preview of the HTML version of the email body.' => 'Eine Vorschau der HTML-Version des E-Mail-Inhalts.',
    'A preview of the plaintext version of the email body.' => 'Eine Vorschau der Klartextversion des E-Mail-Inhalts.',
    'Access utility' => 'Zugangshilfsmittel',
    'Activate Sending' => 'Senden aktivieren',
    'Active' => 'Aktiv',
    'Add a campaign' => 'Kampagne hinzufügen',
    'Add a contact' => 'Kontakt hinzufügen',
    'Add a mailing list' => 'Mailingliste hinzufügen',
    'Add a name and email' => 'Name und E-Mail hinzufügen',
    'Add a segment' => 'Segment hinzufügen',
    'Add the appropriate webhook URL to trigger complain and bounce notifications (works for the listed services only).' => 'Fügen Sie die entsprechende Webhook-URL hinzu, um Beschwerde- und Absprung-Benachrichtigungen auszulösen (funktioniert nur für die aufgeführten Dienste).',
    'Add the following tag to all Campaign forms (not doing so will prevent forms from submitting).' => 'Fügen Sie das folgende Tag zu allen Kampagnenformularen hinzu (andernfalls werden die Formulare nicht gesendet).',
    'Added' => 'Hinzugefügt',
    'Administrative changes are disallowed in this environment.' => 'Administrative Änderungen sind in dieser Umgebung nicht zulässig.',
    'Alias Check Failed – one of your site or asset volume URLs is using a dynamic `@web` alias.' => 'Alias-Prüfung fehlgeschlagen - eine Ihrer Site- oder Asset-Volume-URLs verwendet einen dynamischen `@web`-Alias.',
    'All campaigns' => 'Alle Kampagnen',
    'All contacts' => 'Alle Kontakte',
    'All mailing lists' => 'Alle Mailinglisten',
    'All segments' => 'Alle Segmente',
    'All sendouts' => 'Alle Aussendungen',
    'All systems are GO!' => '',
    'All' => '',
